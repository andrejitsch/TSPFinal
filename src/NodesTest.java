...
public class NodesTest
{
    ...
    @Test
    public void testYpos() throws Exception
    {
        nodes.setYpos(400);
        int expected = 400;
    ...
    @Test
    public void testInTour() throws Exception
    {
    ...
    {
        String expected = "Node" + nodes.getNumber() +":  " +
                " X: " + nodes.getXpos() + ", Y: " + nodes.getYpos();
    ...
    public void testDistance()
    {
        ...
        assertEquals(expected,nodes.measureDistanceForBruteForce(new Nodes(2, "Freren", 160,10)), 0.001);
    }
}
