...
public class EdgesTest
{
    ...
    {
        Edges expected = new Edges(new Nodes(2, "Lingen", 50, 100),
                new Nodes(3, "Meppen", 100, 200),2);
    ...
    {
        String expected = edges.getSourceNode().toString() + " ------> " + edges.getTargetNode().toString() + ", Weight: " + edges.weight;
